...
CREATE TABLE IF NOT EXISTS `mydb`.`Detalle_Ventas` (
  ...
  INDEX `fk_Detalle_Ventas_Venta1_idx` (`Venta_idVenta` ASC),
  CONSTRAINT `fk_Detalle_Ventas_Producto1`
    FOREIGN KEY (`Producto_idProducto`)
    REFERENCES `mydb`.`Producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Ventas_Venta1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Detalle_Compras` (
  ...
  INDEX `fk_Detalle_Compras_Producto1_idx` (`Producto_idProducto` ASC),
  INDEX `fk_Detalle_Compras_Proveedor1_idx` (`Proveedor_idProveedor` ASC),
  INDEX `fk_Detalle_Compras_Compra1_idx` (`Compra_idCompra` ASC),
  CONSTRAINT `fk_Detalle_Compras_Producto1`
    FOREIGN KEY (`Producto_idProducto`)
    REFERENCES `mydb`.`Producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Compras_Proveedor1`
    FOREIGN KEY (`Proveedor_idProveedor`)
    REFERENCES `mydb`.`Proveedor` (`idProveedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Compras_Compra1`
